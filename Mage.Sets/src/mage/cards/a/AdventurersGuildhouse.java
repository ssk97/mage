...
public final class AdventurersGuildhouse extends CardImpl {
    ...
    public AdventurersGuildhouse(UUID ownerId, CardSetInfo setInfo) {
        ...
        GainAbilityTargetEffect gainAbilityTargetEffect = new GainAbilityControlledEffect(new BandsWithOtherAbility(SuperType.LEGENDARY), Duration.WhileOnBattlefield, filter);
